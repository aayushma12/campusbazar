...
void main() async {
  ...
  if (!Hive.isAdapterRegistered(12)) {
    Hive.registerAdapter(auth_v2.AuthUserModelAdapter());
  }

  // 6. Setup Dependency Injection (GetIt)
  await setupLocator();
  
  runApp(const ProviderScope(child: CampusBazarApp()));
}

class CampusBazarApp extends ConsumerWidget {
