...
class AuthenticationRegisterPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AuthenticationRegisterPage> createState() => _AuthenticationRegisterPageState();
}

class _AuthenticationRegisterPageState extends ConsumerState<AuthenticationRegisterPage> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  _field(controller: _universityController, label: 'University'),
                  const SizedBox(height: 12),
                  _field(controller: _campusController, label: 'Campus'),
